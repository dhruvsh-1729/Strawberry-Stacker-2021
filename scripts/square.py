...
def main():
    ...
    while not rospy.is_shutdown() and a<len(setpoints):
        ...
        diff_x = math.fabs(pos.pose.position.x - stateMt.local_pos.pose.position.x)
        diff_y = math.fabs(pos.pose.position.y - stateMt.local_pos.pose.position.y)
        diff_z = math.fabs(pos.pose.position.z - stateMt.local_pos.pose.position.z)
