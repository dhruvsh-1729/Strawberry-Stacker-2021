...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        for i in range(len(setpoints)-1):
            ...
            dist_x=setpoints[i+1][0]-setpoints[i][0]
            pos.pose.position.x+=dist_x
            if(dist_x>=0):
                while(stateMt.local_pos.pose.position.x<pos.pose.position.x and a==1):
            ...
            dist_y=setpoints[i+1][1]-setpoints[i][1]
            pos.pose.position.y+=dist_y
            if(dist_y>=0):
                while(stateMt.local_pos.pose.position.y<pos.pose.position.y and b==1):
            ...
            dist_z=setpoints[i+1][2]-setpoints[i][2]
            pos.pose.position.z+=dist_z
            if(dist_z>=0):
                while(stateMt.local_pos.pose.position.z<pos.pose.position.z and c==1):
